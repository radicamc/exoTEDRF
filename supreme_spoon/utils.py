...
def get_centroids(deepframe, xstart=0, xend=None, save_results=True,
                  save_filename=''):
    """Get the trace centroids via the edgetrigger method.
...
def get_soss_centroids(deepframe, tracetable, subarray, save_results=True,
                       save_filename=''):
